                            ...
                            <div class="card-body">
                                ...
                                <div class="content">
                                    ...
                                    <div class="value"><span class="sign"></span>
                                        <?= mysqli_num_rows(mysqli_query($connection, "SELECT * FROM users WHERE archive_status = 0")) ?>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <a class="card card-banner card-blue-light">
                            <div class="card-body">
                                <i class="icon fa fa-users fa-4x"></i>
                                <div class="content">
                                    <div class="title">View Patients</div>
                                    <div class="value"><span class="sign"></span>
                                        <?= mysqli_num_rows(mysqli_query($connection, "SELECT * FROM patients WHERE archive_status = 0")) ?>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a class="card card-banner card-yellow-light">
                            <div class="card-body">
                                ...
                                <div class="content">
                                    ...
                                    <div class="value"><span class="sign"></span>
                                        <?= mysqli_num_rows(mysqli_query($connection, "SELECT * FROM patients WHERE timestamp BETWEEN DATE_SUB( CURDATE() , INTERVAL 15 DAY ) AND CURDATE()")) ?>
                                    </div>
                                </div>
                            </div>
                        </a>
